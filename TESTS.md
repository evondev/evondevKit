...
## Danh sách màn cần test, theo thứ tự ưu tiên

Mỗi dòng là **một vòng**. Prompt để **ngắn và hở** như người dùng thật gõ, không
liệt kê nội dung, để đo luôn phần mặc định của skill (`S5`, `S10`, `S15`).

Bản theo skill thì thêm dòng đầu:

> Đọc `~/dev/evondevKit/skills/ui-ux/SKILL.md` và làm đúng theo đó, kể cả các file trong `references/` mà nó trỏ tới.

Đuôi chung cho mọi prompt: *"Xuất ra `taste/<tên>.html`, một file HTML dùng
Tailwind qua CDN, không build, mở bằng trình duyệt là chạy. Nội dung tiếng Việt."*

Đánh `[x]` khi đạt, ghi số vòng vào bảng **Đã chạy xong** bên dưới.

### Ưu tiên 1 — lặp lại ở mọi dashboard, skill còn mỏng

- [ ] **Bảng dữ liệu đầy đủ** — "Dựng cho tôi trang quản lý khách hàng dạng bảng, có tìm kiếm, bộ lọc, phân trang và chọn nhiều dòng để xoá hàng loạt." *(vòng 18 hỏng vì hiểu "bảng" thành kanban; test lại `S10` mới)*
- [ ] **Trang chi tiết bản ghi** — "Dựng cho tôi trang chi tiết một khách hàng."
- [ ] **Drawer xem nhanh** — "Dựng cho tôi danh sách đơn hàng, bấm vào một đơn thì mở panel bên phải xem nhanh chi tiết."
- [ ] **Thành viên và phân quyền** — "Dựng cho tôi trang quản lý thành viên trong workspace, có mời thành viên và đổi vai trò."
- [ ] **Hồ sơ cá nhân** — "Dựng cho tôi trang cài đặt hồ sơ cá nhân." *(vòng 8 đã chạy trước đợt đổi luật mặc định, chạy lại)*
- [ ] **Trạng thái rỗng / lỗi / đang tải** — "Dựng cho tôi trang danh sách dự án, kèm ba trạng thái: chưa có dự án nào, đang tải, và lỗi tải dữ liệu."
- [ ] **Khung app có sidebar** — "Dựng cho tôi khung app dashboard có sidebar, sidebar thu gọn được." *(đo luật sidebar mới 21/09)*

### Ưu tiên 2 — hay gặp, skill đã có mẫu

- [x] **Bảng giá** — "Dựng cho tôi trang bảng giá." *(vòng 1-7, 20, 21)*
- [x] **Tổng quan** — "Dựng cho tôi màn hình tổng quan cho app quản lý dự án." *(vòng 11, 12; chạy lại để đo bộ khối mặc định `S5`)*
- [x] **Danh sách có bộ lọc** — "Dựng cho tôi màn hình danh sách công việc có bộ lọc." *(vòng 9)*
- [x] **Kanban** — "Dựng cho tôi bảng kanban quản lý công việc, kéo thả giữa các cột trạng thái." *(vòng 14-16)*
- [x] **Đăng nhập** — "Dựng cho tôi trang đăng nhập." *(vòng 10)*
- [x] **Form tạo mới có lỗi** — "Dựng cho tôi form tạo công việc mới, có hiện lỗi khi nhập sai." *(vòng 17)*
...
- [ ] **Hộp xác nhận xoá** — "Dựng cho tôi hộp thoại xác nhận xoá dự án."
- [ ] **Command palette** — "Dựng cho tôi command palette mở bằng ⌘K."

### Ưu tiên 3 — ít màn hơn nhưng dễ lộ lỗi riêng

- [ ] **Form nhiều bước** — "Dựng cho tôi form tạo workspace mới gồm ba bước."
- [ ] **Tải file lên** — "Dựng cho tôi khu tải tài liệu lên cho một dự án."
...
- [ ] **Lịch** — "Dựng cho tôi trang lịch cho app quản lý công việc." *(đo `S10`: mặc định phải ra lịch tháng)*
- [ ] **Onboarding** — "Dựng cho tôi màn chào mừng lần đầu vào app, có checklist các bước bắt đầu."
- [ ] **Panel thông báo** — "Dựng cho tôi panel thông báo mở từ chuông trên header."

### Ưu tiên 4 — trang hệ thống, làm một vòng gộp
