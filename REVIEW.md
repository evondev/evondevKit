...
| 5 | Thành viên và phân quyền | `/dashboard/members` | 25/09/2026 (bảy lượt; `/register`, `/login`, luồng quên mật khẩu đã theo kịp) |
| 6 | Hồ sơ cá nhân | `/dashboard/profile`, `/profile/states` | |
| 7 | Đăng nhập, đăng ký, quên mật khẩu, OTP | `/login`, `/register`, `/forgot-password`, `/forgot-password/verify`, `/forgot-password/new-password`, `/forgot-password/states`, `/verify-otp`, `/verify-otp/states` | 25/09/2026 (bảy lượt; `/register`, `/login`, luồng quên mật khẩu đã theo kịp) |
