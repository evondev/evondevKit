...
- [ ] **Trang bảo mật**: "Bật xác thực hai lớp" là nút `primary`? Nút đăng xuất hàng loạt đỏ sẵn nhưng cùng cỡ `h-11 md:h-10` với nút "Đăng xuất" trong dòng (cả trang một cỡ nút), còn nút trong dòng chỉ đỏ lúc rê (`I4`, `layouts/app.md`)?
